...
public class Validator {
     ...
     */
    public static boolean validateComponentName(System system, String componentName) {
     ...
     * @return true on success, false otherwise
     */
    public static boolean validateGroupName(System system, String groupName) {
    ...
    public static boolean validateFieldName(TechnicalEntity entity, String fieldName) {
